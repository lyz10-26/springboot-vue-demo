<template>
  <div style="padding: 10px">
    ...
    <div style="margin: 10px 0">
      <el-button type="primary" @click="add" v-if="user.id === 1">新增</el-button>
      <el-popconfirm
          v-if="user.id === 1"
          title="确定删除吗？"
          @confirm="deleteBatch"
    ...
    >
      ...
      <el-table-column label="操作" width="240">
        <template #default="scope">
          ...
          <el-button size="mini" @click="handleEdit(scope.row)" v-if="user.id === 1">编辑</el-button>
          <el-popconfirm title="确定删除吗？" @confirm="handleDelete(scope.row.id)" v-if="user.id === 1">
            <template #reference>
